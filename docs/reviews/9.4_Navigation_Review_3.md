...
**Impact Analysis**:
- ✅ Allows JoinGroupScreen to receive inviteCode via deep linking (`Stepper://main/join/ABC123`)
...
Auth: 'auth',
```
This required URLs like `Stepper://auth/login`
...
- ✅ `Stepper://login` (direct, no 'auth' prefix)
- ✅ `Stepper://register` (direct, no 'auth' prefix)
- ✅ `Stepper://forgot-password` (direct, no 'auth' prefix)
- ✅ `https://Stepper.com/login` (universal links)
- ✅ `https://Stepper.com/register` (universal links)
- ✅ `https://Stepper.com/forgot-password` (universal links)
...
- `Stepper://login` → LoginScreen
- `Stepper://register` → RegisterScreen
- `Stepper://forgot-password` → ForgotPasswordScreen

**Main App Flows**:
- `Stepper://main/home` → HomeScreen
- `Stepper://main/steps` → StepsHistoryScreen
- `Stepper://main/friends` → FriendsListScreen
- `Stepper://main/friends/discover` → FriendDiscoveryScreen
- `Stepper://main/user/:userId` → UserProfileScreen
- `Stepper://main/groups` → GroupsListScreen
- `Stepper://main/group/:groupId` → GroupDetailScreen
- `Stepper://main/group/:groupId/manage` → GroupManagementScreen
- `Stepper://main/groups/create` → CreateGroupScreen
- `Stepper://main/join/:inviteCode` → JoinGroupScreen ✅ (fixed with parameter)
- `Stepper://main/settings` → SettingsScreen
- `Stepper://main/settings/profile` → ProfileScreen
- `Stepper://main/settings/profile/edit` → EditProfileScreen
- `Stepper://main/notifications` → NotificationsScreen

**Onboarding**:
- `Stepper://onboarding` → OnboardingScreen
...
4. **Plan Documentation** (Issue #3):
   - `/mnt/c/Users/rene_/source/repos/Stepper/docs/plans/9.4_Navigation.md`
