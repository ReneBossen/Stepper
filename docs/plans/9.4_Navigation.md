...
Implement React Navigation with authentication flow, bottom tab navigation for main screens, stack navigation for nested flows, and deep linking for invite codes and friend requests. This creates the navigational backbone for the entire mobile app.
...
Create placeholder screens in their respective folders:
- `src/screens/auth/` - LoginScreen, RegisterScreen, ForgotPasswordScreen
- `src/screens/home/` - HomeScreen
- `src/screens/steps/` - StepsHistoryScreen
- `src/screens/friends/` - FriendsListScreen, etc.
- `src/screens/groups/` - GroupsListScreen, etc.
- `src/screens/settings/` - SettingsScreen, etc.
